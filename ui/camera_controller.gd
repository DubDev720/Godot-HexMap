...
func ensure_camera(owner: Node3D, focus_world_position: Vector3) -> Camera3D:
    if owner.has_node("Camera3D"):
        var existing_camera := owner.get_node("Camera3D") as Camera3D
